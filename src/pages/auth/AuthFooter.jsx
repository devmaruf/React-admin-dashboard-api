        ...
        <Row className="g-3">
          <Col lg={6} className="order-lg-last">
            <ul className="nav nav-sm justify-content-center justify-content-lg-end">
              <li className="nav-item">
                <Link className="nav-link" target="_blank" to={`${import.meta.env.VITE_PUBLIC_URL}/auths/terms`}>
                  Terms &amp; Condition
                </Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <Link className="nav-link" target="_blank" to={`${import.meta.env.VITE_PUBLIC_URL}/auths/faq`}>
                  Help
                </Link>
              </li>
              <li className="nav-item ">
          ...
          <Col lg="6">
            <div className="nk-block-content text-center text-lg-left">
              <p className="text-soft">&copy; {new Date().getFullYear()} Deshibazar. All Rights Reserved.</p>
            </div>
          </Col>
        </Row>
      </div>
